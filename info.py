...
BOT_TOKEN = environ.get('BOT_TOKEN', '6624184873:AAGIWEee77IawF0eik8eu7IuuwZ8Hq0U8PE')

ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5397984467').split()]
USERNAME = environ.get('USERNAME', "https://telegram.me/BarkesyaXboy")
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002198026835'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+WnJamUqcp_UwNDM1')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001234567898').split()]
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://INCOGNITOBOTS:INCOGNITOBOTS@cluster0.wdovemr.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")

DATABASE_NAME = environ.get('DATABASE_NAME', "TELEGRAM_BOT_INFO")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002198026835'))
QR_CODE = environ.get('QR_CODE', 'https://telegra.ph/file/0bce1ff0bf272ed4b3f50.jpg')
...
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002198936292'))
